#!/usr/bin/env node
/**
 * gemini-eval.mjs — Gemini-powered Job Offer Evaluator for uni-ops
 *
...
const PATHS = {
  ...
  evaluate: join(ROOT, '.claude', 'skills', 'uni-ops', 'SKILL.md'),
  cv:       join(ROOT, 'cv.md'),
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           uni-ops — Gemini Evaluator (free-tier)             ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
const systemPrompt = `You are uni-ops, an AI-powered job search assistant.
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  UNI-OPS EVALUATION — powered by Google Gemini');
