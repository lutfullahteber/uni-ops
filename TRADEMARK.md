# uni-ops Trademark Policy

This document explains how the "uni-ops" name and brand may be used.
...
"uni-ops," its visual identity, or any associated brand assets.
...
- **Describing compatibility, origin, and lineage** — "works with
  uni-ops," "based on uni-ops," "fork of uni-ops," "extends
  uni-ops" are all welcome and encouraged with attribution.
- **Naming a fork distinctly** — pick your own product name; mention
  uni-ops as origin if you like.
...
- **Product, service, or company names** that include "uni-ops" or
  close variants. This includes prefixes, suffixes, and capitalizations:
  "uni-ops Cloud," "uni-ops Pro," "uni-ops SaaS," "Uni-Ops
  Hosted," "UniOps by [vendor]," "Cloud uni-ops," etc.
- **Endorsement, sponsorship, or affiliation claims** in any context:
  "Powered by uni-ops," "Official uni-ops," "Sponsored by
  uni-ops," "Partner of uni-ops," "Featured by uni-ops," and
  similar phrasings.
- **Domain names, social handles, and app store listings** containing
  "uni-ops" or close variants for commercial purposes.
...
- **Compatibility certifications** that imply official testing or
  approval ("uni-ops Certified," "uni-ops Verified").
...
uni-ops is a community-built project used by tens of thousands of
...
© 2026 Santiago Fernández de Valderrama. "uni-ops"™ is a trademark of
