...
# uni-ops batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
uni-ops batch runner — process job offers in batch via claude -p workers
