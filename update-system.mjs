...
/**
 * update-system.mjs — Safe auto-updater for uni-ops
 *
...
const CANONICAL_REPO = 'https://github.com/santifer/uni-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/santifer/uni-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/santifer/uni-ops/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'uni-ops-update-checker',
        },
